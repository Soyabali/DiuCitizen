...
class ImageAssets {
  ...
  static const String logoapp = "$IMAGE_PATH/ic_launcher.png";
  static const String logo = "$IMAGE_PATH/logo.png";
  static const String cuttackmani = "$IMAGE_PATH/cuttackmanicipal.jpeg";
  static const String cuttackshashan = "$IMAGE_PATH/cuttackshashan.jpeg";
  static const String cuttack = "$IMAGE_PATH/cuttack.png";
  static const String favicon = "$IMAGE_PATH/favicon.png";
  static const String bggrid = "$IMAGE_PATH/bggrid.jpeg";
}
class JsonAssets {
