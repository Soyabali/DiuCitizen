...
import '../../services/getImportentLinksRepo.dart';
...
class _OnlineComplaintState extends State<Importantlink> {
  ...
  getEmergencyTitleResponse() async {
    emergencyTitleList = await GetImportentLinksRepo().getImportentLinks(context);
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            final sTitle = emergencyTitleList![index]['sTitle'];
                            final sLink = emergencyTitleList![index]['sLink'];
                            print("--Title--: $sTitle");
                            print("--Link--: $sLink");
                            Navigator.push(
                               context,
                          ...
                          child: ListTile(
                            ...
                            // Title
                            title: Text(
                              emergencyTitleList![index]['sTitle']!,
