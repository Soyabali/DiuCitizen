...
import '../license/licenseStatus/tradedetails.dart';
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  var WaterSupplyStatus = "${item['WaterSupplyStatus']}";
                  return Padding(
                                        ...
                                        children: [
                                          InkWell(
                                            onTap: () {
                                              ...
                                              var licenseRequestId = "${item['iWaterTaxReqId'].toString() ?? ''}";
                                              print("---445--$licenseRequestId");

                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) => WaterSupplyTaxtTypelist(licenseRequestId:licenseRequestId),
                                                ),
                                              );
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text("Remarks",style: AppTextStyle
                                                      .font14OpenSansRegularBlack45TextStyle),
                                                  SizedBox(height: 5),//  dActionRemarks
                                                  Text( item['dActionRemarks'] ?? '',style: AppTextStyle
                                                      .font14OpenSansRegularRedTextStyle,
                                                  ),
                                                ],
                                              ),
