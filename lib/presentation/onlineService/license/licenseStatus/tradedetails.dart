...
class TradeDetailsPage extends StatefulWidget {
  ...
  const TradeDetailsPage({super.key, required this.licenseRequestId});
...
class _TradeDetailsPageState extends State<TradeDetailsPage> {
  ...
  pendingInternalComplaintResponse(licenseRequestId) async {
    pendingInternalComplaintList = await GetLisenceTradeList().getLisence(context,licenseRequestId);
                             ...
                             // Text(item['sItemName'], style: AppTextStyle.font14OpenSansRegularBlack45TextStyle),
                              Row(
                               ...
                               children: <Widget>[
                                 ...
                                 SizedBox(width: 2),
                                 Text(item['sTradeCategoryName'], style: AppTextStyle.font14OpenSansRegularBlack45TextStyle),
                               ],
                             ),
                              SizedBox(height: 4),
                              Text('Category Name', style: AppTextStyle.font14OpenSansRegularBlack45TextStyle),
                            ],),
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(item['sTradeName'], style: AppTextStyle.font14OpenSansRegularBlackTextStyle),
                                    ],
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 15),
                                    child: Text('Trade Name', style: AppTextStyle.font14OpenSansRegularBlack45TextStyle),
                                  ),
                                ],
                              ),
                            ),
