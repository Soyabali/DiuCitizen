...
class PostlicenseRequestRepo {
  // this is a loginApi call functin
  GeneralFunction generalFunction = GeneralFunction();

  Future postLicenseRequest(
    ...
    try {
      ...
      /// TODO CHANGE HERE
      var endPoint = "PostLicenseRequest/PostLicenseRequest";
...
//Your API call
      ...
      var request = http.Request(
          'POST',
          Uri.parse('http://115.244.7.153/diucitizenapi/api/PostLicenseRequest/PostLicenseRequest'));
      request.body =
