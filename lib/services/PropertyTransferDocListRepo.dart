...
class PropertyTransferDocListRepo {

  GeneralFunction generalFunction = GeneralFunction();

  Future<List<Map<String, dynamic>>?> propertyTransferDocs(BuildContext context, licenseRequestId) async {
    ...
    try {
      ...
      var endPoint = "PropertyTransferDocList/PropertyTransferDocList";
