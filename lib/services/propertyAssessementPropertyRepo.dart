...
class PropertyAssessementPropertyRepo {

  GeneralFunction generalFunction = GeneralFunction();

  Future<List<Map<String, dynamic>>?> assessementProperty(BuildContext context) async {
    ...
    try {
      ...
      var endPoint = "PropertyAssessmentStatus/PropertyAssessmentStatus";
