...
class GetLisenceDataDocsRepo {

  GeneralFunction generalFunction = GeneralFunction();

  Future<List<Map<String, dynamic>>?> getLisenceDataDocs(BuildContext context, licenseRequestId) async {
    ...
    try {
      ...
      var endPoint = "GetLicenceDataDocs/GetLicenceDataDocs";
