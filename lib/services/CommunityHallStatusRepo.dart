...
class CommunityHallStatusRepo {

  GeneralFunction generalFunction = GeneralFunction();

  Future<List<Map<String, dynamic>>?> communityHall(BuildContext context) async {
    ...
    try {
      ...
      var endPoint = "CommunityHallStatus/CommunityHallStatus";
