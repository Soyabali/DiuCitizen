...
//       print('----selectedDates---$seleccteddates');
//
//
//       var baseURL = BaseRepo().baseurl;
//
...
//
//       String jsonResponse =
//           '{"sArray":[{"sBookingReqId":"$sBookingReqId","sApplicantName":"$sApplicantName","sMobileNo":"$sMobileNo","sAddress":"$sAddress","iCommunityHallName":"$iCommunityHallName","iDaysOfBooking":"$iDaysOfBooking","fAmount":"$fAmount","dPurposeOfBooking":"$dPurposeOfBooking","sCreatedBy":"$sCreatedBy","sBookingDateArray":"$seleccteddates"}]}';
//
//
//       // String jsonResponse =
...
//       var headers = {'token': '$token', 'Content-Type': 'application/json'};
//
//       var request = http.Request('POST', Uri.parse('http://115.244.7.153/diucitizenapi/api/PostCommunityBookingHallReq/PostCommunityBookingHallReq'));
//       request.body =
//           updatedJsonResponse; // Assign the JSON string to the request body
//       request.headers.addAll(headers);
//       http.StreamedResponse response = await request.send();
