...
class GetLisenceTradeList {

  GeneralFunction generalFunction = GeneralFunction();

  Future<List<Map<String, dynamic>>?> getLisence(BuildContext context, licenseRequestId) async {
    ...
    try {
      ...
      var endPoint = "GetLisenceTradeList/GetLisenceTradeList";
